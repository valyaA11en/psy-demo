...
export function humanizeCode(value: string | null | undefined) {
  ...
  const dictionary: Record<string, string> = {
    ...
    sent: "доставлено",
    paid: "оплачен",
    paid_via_package: "покрыто пакетом",
    uploaded: "загружен",
    deleted: "удален",
    private: "приватный",
    public: "публичный",
    ...
    "chat.message.created": "новое сообщение в чате",
    "homework.assigned": "назначено домашнее задание",
    "homework.completed": "задание выполнено",
    "homework.cancelled": "задание отменено",
    "session_package.purchased": "активирован пакет сессий",
